...
* **App infrastructure repo**: [infrastructure repo](https://github.com/adel-hesham/Todo-appliaction-infra) This repository includes the Terraform AWs infrastructure and Ansible nexus repo confiquration for this projejct
